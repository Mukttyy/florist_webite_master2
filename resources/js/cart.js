$(document).ready(function(){
    ...
    function renderCart() {
        ...
        if (cart.length === 0) {
            cartContent('<p class="text-center text-muted">Keranjang belanja Anda kosong.</p><div class="text-center"><a href="index" class="btn btn-primary">Mulai Belanja</a></div>');
            return;
        }
